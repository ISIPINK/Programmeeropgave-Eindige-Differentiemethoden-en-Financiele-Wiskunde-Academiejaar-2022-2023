...
\oefening{3}
Kijk naar figuur\ref{fig:muA} voor $\mu(A)$ voor verschillende $m$. 
$\mu(A)$ groeit even snel als $m^{2}$ (kijk grafiek). Dit kan waarschijnlijk
bewezen worden met $\mu_{1}, \mu_{2}$ afschatting. Dit betekent dat we geen
stabiliteit hebben voor $T = \infty$. 

\begin{figure}
\includegraphics[width=\linewidth]{oefening3.png}
\caption{ $(\mu(A), m^2)$ vs $m$}\label{fig:muA}
\end{figure}
